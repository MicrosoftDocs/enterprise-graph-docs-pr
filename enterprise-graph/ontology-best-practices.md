...
Creating an effective and long-lasting ontology is a very deep and broad field of study, and becoming an expert in it is well outside the scope of this documentation. However, there are some general best-practices and tips we'd like to share based on our experience of building a global-level ontology at Microsoft, which you may find useful in building an enterprise-level ontology and set of applications.
